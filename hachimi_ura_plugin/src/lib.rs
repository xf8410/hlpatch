...
unsafe fn read_summary_inner() -> String {
    ...
    format!(
        r#"{{"version":"3.16.1","month":{},"half":{},"scenario":"{}","stats":{{"speed":{},"stamina":{},"power":{},"guts":{},"wiz":{},"vital":{},"max_vital":{},"motivation":"{}","skill_point":{},"fan":{}}},"trainings":{},"support_cards":{},"evaluation":{},"training_levels":{},"buffs":{},"chara_effect_ids":[{}],"ai":{}{}}}"#,
...
fn handle_http(mut stream: std::net::TcpStream) {
    ...
    let body = if path == "/" || path == "/health" {
        r#"{"status":"ok","version":"3.16.1","endpoints":["/summary","/data","/scenario","/debug/params","/debug/breeders","/carddb","/skilldata","/log","/status","/health"]}"#.to_string()
    } else if path == "/scan" {
...
fn read_carddb() -> String {
    ...
    format!(
        r#"{{"ok":true,"version":"3.16.1","mdb":"{}","card_count":{},"effect_count":{},"cards":[{}],"effects":[{}]}}"#,
...
fn read_skilldata() -> String {
    ...
    format!(
        r#"{{"ok":true,"version":"3.16.1","mdb":"{}","skill_count":{},"name_count":{},"point_count":{},"skills":[{}],"names":[{}],"need_points":[{}]}}"#,
